...
public class DepartmentListController implements Initializable, DataChangeListener{
	...
	private ObservableList<Department> obsList;   //recebe os departmentos e é associada a tableViewDepartment
	...
	public void updateTableView() {          //responsavel por acessar os serviços, carregar e jogar os deparmentos na obsList
		if(service == null) {
	...
	private void createDialogForm(Department obj, String pathname, Stage parentStage) {
		try {
			...
			controller.subscribeDataChangeListener(this); // inscrição para receber o evento que dispara o updateTableView
			...
			dialogStage.initModality(Modality.WINDOW_MODAL);  //enquanto não fechar a janela, nao pode mexer na anterior
