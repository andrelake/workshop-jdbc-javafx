...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	public void updateTableView() { // responsavel por acessar os serviços, carregar e jogar os deparmentos na
									// obsList
		if (service == null) {
	...
	private void createDialogForm(Department obj, String pathname, Stage parentStage) {
		try {
			...
			controller.subscribeDataChangeListener(this); // inscrição para receber o evento que dispara o
															// updateTableView
